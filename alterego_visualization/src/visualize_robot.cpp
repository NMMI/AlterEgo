...
void visualize_robot::callback_upperbody_state(const alterego_msgs::UpperBodyState::ConstPtr &msg)
{
...
void visualize_robot::callback_lowerbody_state(const alterego_msgs::LowerBodyState::ConstPtr &msg)
{
