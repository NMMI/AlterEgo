...
#include <pilot_bridge/EnableAutoModeService.h>
#include <pilot_bridge/WaitPilotService.h>
using namespace KDL;
using namespace std;
...
bool waitPilotCallback(pilot_bridge::WaitPilotService::Request &req, pilot_bridge::WaitPilotService::Response &res)
{
	if(req.request == true)
		restart_agent_cnt = 0;
...
bool enableAutoModeCallback(pilot_bridge::EnableAutoModeService::Request &req, pilot_bridge::EnableAutoModeService::Response &res)
{
