 ...
 *                                                                      *
 *----------------------------------------------------------------------*/
void robot_state__Callback(const ego_msgs::UpperBodyState::ConstPtr &msg)
{
...
int main(int argc, char **argv)
{
	...
	if (sim)
	{
		n.getParam("standing_pitch_offset_simulated", standing_pitch_offset);
	}
	else
	{
	...
	while (ros::ok())
	{
		...
		// offset_phi_pub.data = atan2(tot_cm(0), tot_cm(2)) + standing_pitch_offset;
