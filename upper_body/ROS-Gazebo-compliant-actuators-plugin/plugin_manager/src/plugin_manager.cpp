...
void Initialization(ros::NodeHandle n_)
{
  ...
  {
    topics_ref1[i]  = joint_name[i] + ref1_topic_name[i];
    topics_ref2[i]  = joint_name[i] + ref2_topic_name[i];
    topics_state[i] =    joint_name[i] + "/link_state";
    mot1_state[i] =   joint_name[i] + "/motor_1_state";
    mot2_state[i] =   joint_name[i] + "/motor_2_state";
  }
  topic_state_name =    "alterego_state";
  topic_mot1state_name =  "motor_1_state";
  topic_mot2state_name =   "motor_2_state";
  ...
  std::string sub_ref1_name =    "reference_1";
  std::string sub_ref2_name =  "reference_2";
...
int main(int argc, char **argv)
{
  ...
  // Wait for the service from Controller A
  ros::service::waitForService("/"+robot_name+"/wheels/controller_manager/load_controller");
