...
private:
  ...
  void lowerbody_state__Callback(const ego_msgs::LowerBodyState::ConstPtr &msg);
  ...
  void callback_ego_state(const ego_msgs::AlteregoState::ConstPtr &msg);
  ...
  ego_msgs::AlteregoState state_info;
  ego_msgs::DebugLQR state_debug_;
  ego_msgs::LowerBodyState lowerbody_state_msg_;
  // --------------------------------------------------------------------------------------------------- double
